    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="flex items-center gap-1">
        ...
        <input
          ...
          min={min}
          max={max}
          className="flex-1 min-w-0 bg-elevated border border-border-default rounded-lg px-2 py-1.5 text-center text-sm font-body text-primary focus:outline-none focus:ring-1 focus:ring-amber-500 transition-colors"
          {...props}
        />
        <button
          type="button"
