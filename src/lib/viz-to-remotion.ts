...
function commonPropsOf(t: CommonAnimationConfig | undefined, config?: ChartConfig): Record<string, unknown> {
  return {
    ...
    backgroundGradientShape: t?.backgroundGradientShape,
    backgroundGradientCenterX: t?.backgroundGradientCenterX,
    backgroundGradientCenterY: t?.backgroundGradientCenterY,
    backgroundGradientRadius: t?.backgroundGradientRadius,
    backgroundGradientBlend: t?.backgroundGradientBlend,
    backgroundGradientSmooth: t?.backgroundGradientSmooth,
...
function convertTimelineRace(
  ...
  const presentationOf = (t: TimelineRaceConfig | undefined) => ({
    ...
    avatarBg: t?.avatarBg,
    avatarBgFromBar: t?.avatarBgFromBar,
...
function convertRaceScrolling(
  ...
  const presentationOf = (t: RaceScrollingConfig | undefined) => ({
    ...
    finaleAnimation: t?.finaleAnimation,
    minBarWidth: t?.minBarWidth,
    minBarWidthClose: t?.minBarWidthClose,
    maxRows: t?.maxRows,
